...
exports.SayTruyenInfo = {
    ...
    websiteBaseURL: `https://saytruyenvip.net/`,
    ...
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return createManga({
                ...
                image: (image === null || image === void 0 ? void 0 : image.includes('http')) ? image : ((image === null || image === void 0 ? void 0 : image.includes('//')) ? ('https:' + image.replace('//st.truyenchon.com', '//st.imageinstant.net')) : ('https://saytruyenvip.net/' + image)),
                status,
