...
exports.qMangaInfo = {
    ...
    websiteBaseURL: `https://qmanga5.net/`,
...
class qManga extends paperback_extensions_common_1.Source {
    ...
    getHomePageSections(sectionCallback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let request = createRequestObject({
                url: 'https://qmanga5.net/de-nghi/pho-bien/moi-nhat',
                method: "GET",
            });
            let data = yield this.requestManager.schedule(request, 1);
            let $ = this.cheerio.load(data.data);
            ...
            request = createRequestObject({
                url: 'https://qmanga5.net/danh-muc/noi-bat',
                method: "GET",
            });
            let hotItems = [];
            ...
            //view
            request = createRequestObject({
                url: 'https://qmanga5.net/danh-muc/pho-bien',
                method: "GET",
            });
            let viewItems = [];
            data = yield this.requestManager.schedule(request, 1);
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (homepageSectionId) {
                case "new_updated":
                    url = `https://qmanga5.net/de-nghi/pho-bien/moi-nhat?page=${page}`;
                    select = 1;
                    break;
                case "hot":
                    url = `https://qmanga5.net/danh-muc/noi-bat?page=${page}`;
                    select = 2;
                    break;
                case "view":
                    url = `https://qmanga5.net/danh-muc/pho-bien?page=${page}`;
                    select = 3;
                    break;
                default:
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = createRequestObject({
                url: query.title ? encodeURI(`https://qmanga5.net/tim-kiem?q=${query.title}&page=${page}`) :
                    (tags[0].includes('http') ? (tags[0] + `?page=${page}`) :
                        encodeURI(`https://qmanga5.net/danh-muc/${search.cate}?page=${page}`)),
                method: "GET",
            });
            let data = yield this.requestManager.schedule(request, 1);
            let $ = this.cheerio.load(data.data);
    ...
    getSearchTags() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tags2 = [
                {
                    id: 'https://qmanga5.net/bang-xep-hang/top-ngay',
                    label: 'Top ngày'
                },
                {
                    id: 'https://qmanga5.net/bang-xep-hang/top-tuan',
                    label: 'Top tuần'
                },
                {
                    id: 'https://qmanga5.net/bang-xep-hang/top-thang',
                    label: 'Top tháng'
                }
            ];
            const tags5 = [
