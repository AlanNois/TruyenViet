...
class GocTruyenTranh extends paperback_extensions_common_1.Source {
    ...
    getChapters(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `https://goctruyentranhvui.com/api/comic/${mangaId.split("::")[1]}/chapter?offset=0&limit=-1`,
                method,
            });
            const data = yield this.requestManager.schedule(request, 1);
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let request = createRequestObject({
                url: 'https://goctruyentranhvui.com/api/comic/search/view?p=0',
                method: "GET",
            });
            ...
            request = createRequestObject({
                url: 'https://goctruyentranhvui.com/api/comic/search/recent?p=0',
                method: "GET",
            });
            ...
            url = DOMAIN;
            request = createRequestObject({
                url: 'https://goctruyentranhvui.com/api/comic/search/new?p=0',
                method: "GET",
            });
            data = yield this.requestManager.schedule(request, 1);
            json = (typeof data.data) === 'string' ? JSON.parse(data.data) : data.data;
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (homepageSectionId) {
                case "hot":
                    url = `https://goctruyentranhvui.com/api/comic/search/view?p=${page}`;
                    break;
                case "new_updated":
                    url = `https://goctruyentranhvui.com/api/comic/search/recent?p=${page}`;
                    break;
                case "new_added":
                    url = `https://goctruyentranhvui.com/api/comic/search/new?p=${page}`;
                    break;
                default:
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = createRequestObject({
                url: query.title ? encodeURI(`https://goctruyentranhvui.com/api/comic/search?name=${query.title}`) : `https://goctruyentranhvui.com/api/comic/search/category?p=${page}&value=${tags[0]}`,
                method: "GET",
            });
            const data = yield this.requestManager.schedule(request, 1);
            const json = (typeof data.data) === 'string' ? JSON.parse(data.data) : data.data;
    ...
    getSearchTags() {
        return __awaiter(this, void 0, void 0, function* () {
            const url = `https://goctruyentranhvui.com/api/category`;
            const request = createRequestObject({
                url: url,
                method: "GET",
            });
