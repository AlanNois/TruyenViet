...
class VlogTruyen extends paperback_extensions_common_1.Source {
    ...
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tags = $('.categories-list-detail-commic > li > a').toArray().map((t) => {
                var _a;
            ...
            const image = (_a = $('.image-commic-detail img').attr('data-src')) !== null && _a !== void 0 ? _a : "";
            return createManga({
                id: mangaId,
                author: creator,
                artist: creator,
    ...
    getChapters(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const chapters = [];
            $('li').toArray().reverse().forEach((obj, i) => {
                var _a;
                const id = $('a', obj).first().attr('href').split('/').slice(3, 5).join('/');
                const chapNum = Number((_a = $('a', obj).first().attr('title')) === null || _a === void 0 ? void 0 : _a.split(' ')[1]);
    ...
    getChapterDetails(mangaId, chapterId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(data.data);
            const pages = $('#aniimated-thumbnial > img').map((_, obj) => {
                var _a;
                const link = (_a = $(obj).attr('src')) !== null && _a !== void 0 ? _a : "";
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(sectionData.map((data) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c;
                const request = createRequestObject({
                    url: data.url,
                    method: "GET",
                ...
                for (const element of $('.commic-hover', '#ul-content-pho-bien').slice(0, 20).toArray()) {
                    ...
                    const id = (_c = (_b = $('a', element).first().attr('href')) === null || _b === void 0 ? void 0 : _b.split('/').pop()) !== null && _c !== void 0 ? _c : "";
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(data.data);
            const manga = VlogTruyenParser_1.parseViewMore($);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tags.forEach((value) => {
                ...
                if (category === 'translator')
                    search.translator = option;
                if (category === 'writer')
                    search.writer = option;
                if (category === 'status')
