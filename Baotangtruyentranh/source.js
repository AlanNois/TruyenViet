...
class Baotangtruyentranh extends paperback_extensions_common_1.Source {
    ...
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tags = $('.kind a').map((_, element) => {
                const genre = $(element).text().trim();
                const id = $(element).attr('href') || genre;
                return createTag({ label: BaotangtruyentranhParser_1.decodeHTMLEntity(genre), id });
            }).get();
            console.log(tags);
            const creator = BaotangtruyentranhParser_1.decodeHTMLEntity($('.author p').last().text().trim());
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newUpdatedItems = $('.row .item').map((_, element) => {
                var _a;
                const title = $('h3 > a', element).text().trim();
                const image = $('.image img', element).attr("src");
                const id = (_a = $('h3 > a', element).attr('href')) === null || _a === void 0 ? void 0 : _a.split('/').slice(-2).join('/');
            ...
            featuredItems = $('.items-slide .item').map((_, element) => {
                ...
                const id = (_a = $('a', element).attr('href')) === null || _a === void 0 ? void 0 : _a.split('/').slice(-2).join('/');
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(data.data);
            const manga = BaotangtruyentranhParser_1.parseViewMore($);
            const nextPage = !BaotangtruyentranhParser_1.isLastPage($) ? { page: page + 1 } : undefined;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            $('.megamenu .nav a').each((_, tag) => {
                ...
                if (label === 'Tất cả')
                    id = 'cate.';
                if (id && label) {
                    tags.push({ id, label: BaotangtruyentranhParser_1.decodeHTMLEntity(label) });
                }
            });
            const tagSections = [
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseChapterList = exports.decodeHTMLEntity = exports.isLastPage = exports.parseViewMore = exports.parseSearch = exports.generateSearch = exports.capitalizeFirstLetter = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
...
exports.generateSearch = (query) => {
    var _a;
    const keyword = (_a = query.title) !== null && _a !== void 0 ? _a : "";
...
exports.parseSearch = ($) => {
    ...
    $('.row .item').each((_, element) => {
        ...
        manga.push(createMangaTile({
            ...
            subtitleText: createIconText({ text: exports.decodeHTMLEntity(chapter) }),
        }));
    });
    return manga;
};
...
function parseChapterList($, mangaId) {
    ...
    $('ul .row:not(.heading)').each((_, obj) => {
        ...
        const chapNum = parseFloat((_a = $('a', obj).first().text()) === null || _a === void 0 ? void 0 : _a.split(' ')[1]);
